...
import id.ac.polbeng.jumiatiriyana.kabupatenkotariauapp.databinding.ItemListKabkotaBinding

class ListKabKotaAdapter(private val listKabKota:
                         ArrayList<KabKota>):
    ...
    override fun onCreateViewHolder(
        ...
        val binding =
            ItemListKabkotaBinding.inflate(
    ...
    override fun onBindViewHolder(
        ...
        val (gambar, kabupaten_kota, pusat_pemerintahan) =
            listKabKota[position]
        ...
        holder.itemView.setOnClickListener {
            ...
            onItemClickCallback.onItemClicked(
                listKabKota[holder.adapterPosition]
            )
        }
    }
